...
namespace CNCSS.Vis
{
    ...
    /// Occt.NET is not safe from arbitrary thread-pool threads. Without <c>Occt.lic</c> it may show
    /// a native license reminder dialog ("Occt.NET!") — see <see cref="OcctLicenseDialogSuppressor"/>.
    /// </summary>
