...
namespace CNCSS.Simulation.Execution
{
    ...
    public sealed class PlaybackLoopResult
    {
        ...
        public MotionBlockKind BlockKind { get; init; } = MotionBlockKind.Auxiliary;
    }
    ...
    public sealed class PlaybackLoopService
    {
        ...
        private MotionBlockKind _currentBlockKind = MotionBlockKind.Auxiliary;
        ...
        public void Reset(Point3D homePosition)
        {
            ...
            _progress = 1.0;
            _currentArc = null;
            _currentBlockKind = MotionBlockKind.Auxiliary;
        }
            ...
            double fpsSlowdownFactor)
        {
            if (!machineIsRunning)
            {
                return new PlaybackLoopResult { CurrentPosition = lastPosition, Progress = _progress, BlockKind = _currentBlockKind };
            }
            ...
            if (_progress >= 1.0)
            {
                ...
                if (decision.EndOfProgram)
                {
                    return new PlaybackLoopResult
                    {
                        ...
                        Progress = _progress,
                        BlockKind = MotionBlockKind.Auxiliary
                    };
                }
                ...
                if (decision.HasMove)
                {
                    ...
                    _currentBlockKind = decision.BlockKind;
                }
            }
